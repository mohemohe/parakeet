...
func initEcho(e *echo.Echo) {
	...
	e.GET("/api/v1/drive/*", controllers.FetchDrive, middlewares.Authorize)
	e.PUT("/api/v1/drive/*", controllers.CopyDriveFile, middlewares.Authorize)
	e.DELETE("/api/v1/drive/*", controllers.DeleteDriveFile, middlewares.Authorize)
